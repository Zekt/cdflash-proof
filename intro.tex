...
\todo{revise}
\begin{alignat*}{3}
	\ttS{\awa{ww}{\actw_{\i{addr}, \i{data}}}} \defeq{}& \{\, (s, \actw, s')&& \mid stable(s) \equiv stable(s') \\ & \omit \span \span \conj \i{volatile(s)[addr \mapsto data]} \equiv \i{volatile(s') \,\}}  \\
	\ttS{\awa{ww}\actf} \defeq{}& \{\, (s, \actf, s')&& \mid \i{volatile(s)} \equiv \i{volatile(s')}\\
	& \quad && \hmid \conj \i{volatile(s)} \equiv \i{stable(s')}\,\} \\
	\ttS{\awa{ww}\actr} \defeq{}& \{\, (s, \actr, s')&& \mid \i{stable(s)} \equiv \i{volatile(s')}\\
	& \quad && \hmid \conj \i{stable(s)} \equiv \i{stable(s')} \,\} \\
	\ttS{\awa{ww}\actwc} \defeq{}& \{\, (s, \actwc, s')&& \mid \i{stable(s)} \equiv \i{stable(s')} \,\} \\
	\ttS{\awa{ww}\actfc} \defeq{}& \{\, (s, \actfc, s')&& \mid \i{volatile(s)} \equiv \i{stable(s')}\\
	& \quad && \hmid \disj \i{stable(s)} \equiv \i{stable(s')} \,\} \\
	\ttS{\awa{ww}\actrc} \defeq{}& \{\, (s, \actrc, s')&& \mid \i{stable(s)} \equiv \i{stable(s')} \,\}
\end{alignat*}
...
\begin{assumption}[observational equivalence]
	...
	\end{multline*}
\end{assumption}
%%This assumption will play a important role in this proof, since now crash-determinacy on \Prog, as defined in \cref{theoremP}, can be derived from crash-determinacy on \Spec.
