...
\newunicodechar{⟩}{\ensuremath{\mathrm{⟩}}}
\newunicodechar{∎}{\ensuremath{\mathrm{∎}}}
\newunicodechar{₁}{\ensuremath{\mathrm{_1}}}
\newunicodechar{₂}{\ensuremath{\mathrm{_2}}}
\newunicodechar{∃}{\ensuremath{\mathrm{∃}}}
\newunicodechar{⊎}{\ensuremath{\mathrm{⊎}}}
\newunicodechar{⊙}{\ensuremath{\mathrm{⊙}}}
\newunicodechar{≐}{\ensuremath{\mathrm{≐}}}
\newunicodechar{↦}{\ensuremath{\mathrm{↦}}}
\newunicodechar{∀}{\ensuremath{\mathrm{∀}}}
\newunicodechar{▸}{\ensuremath{\mathrm{\smallblacktriangleright}}}
\newunicodechar{ᴾ}{\ensuremath{\mathrm{^P}}}
\newunicodechar{ᶜ}{\ensuremath{\mathrm{^c}}}
\newunicodechar{∅}{\ensuremath{\mathrm{\emptyset}}}
\newunicodechar{₃}{\ensuremath{\mathrm{_3}}}
\newunicodechar{∷}{\ensuremath{\mathrm{∷}}}
\newunicodechar{ᴿ}{\ensuremath{\mathrm{^R}}}
\newunicodechar{∈}{\ensuremath{\mathrm{\in}}}
\newunicodechar{•}{\ensuremath{\mathrm{\cdot}}}
...
module theorem2l (Addr : Set) (_≟_ : Addr → Addr → Bool) (Data : Set) where
